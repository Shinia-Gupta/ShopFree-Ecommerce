    ...
    <div class="content">
        ...
        <div class="psuccess">
            ...
            if ($amount) {
               ...
               $vat = $sum*0.1;
               $total = $sum+$vat;
               echo '<p>Total Payable Amount(Including VAT): Rs. '.$total.'</p>';
               echo '<p>Thanks for Purchase.Received your order Successfully. We will contact you soon with delivery details. Here are your order details...<a href="orderdetails.php">Visit Here...</a></p>';
            }
             ?>
        </div>
